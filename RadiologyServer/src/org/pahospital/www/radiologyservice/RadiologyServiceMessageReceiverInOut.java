        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("requestAppointment".equals(methodName)){
                ...
                org.pahospital.www.radiologyservice.Appointment appointment25 = null;
	                        org.pahospital.www.radiologyservice.Appointment wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), appointment25, false, new javax.xml.namespace.QName("http://www.PAHospital.org/RadiologyService/",
                                                    "requestAppointment"));
                                    } else 

            if("orderRadiologyExamination".equals(methodName)){
                
                org.pahospital.www.radiologyservice.RadiologyOrderID radiologyOrderID27 = null;
	                        org.pahospital.www.radiologyservice.RadiologyOrder wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), radiologyOrderID27, false, new javax.xml.namespace.QName("http://www.PAHospital.org/RadiologyService/",
                                                    "orderRadiologyExamination"));
                                    } else 

            if("getOrderStatus".equals(methodName)){
                
                org.pahospital.www.radiologyservice.OrderStatus orderStatus29 = null;
	                        org.pahospital.www.radiologyservice.RadiologyOrderID wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), orderStatus29, false, new javax.xml.namespace.QName("http://www.PAHospital.org/RadiologyService/",
                                                    "getOrderStatus"));
